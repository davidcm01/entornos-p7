					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<h3>Baja Jugador</h3>
								<form action="operaciones_alu.jsp?tipo=bajajugador" method="post">
									<div class="row gtr-50">
										
										<div class="">
											
											
											<select name="cod_jugador" id="cod_jugador" is ="ms-dropdown" required style="width:450px" data-child-height="415">
											<option value="0">Seleccione un jugador</option>
											<%for(int i =0;i<jugadores.size();i++){	%>
											
											<option value="<%=jugadores.get(i).getCod_jugador() %>"data-image="images/jugadores/<%=jugadores.get(i).getCod_jugador() %>.png"><%=jugadores.get(i).getNombre()%></option>
											<%} %>
											</select>
