...
Equipo equipo = bdcontroller.dameEquipo(Integer.parseInt(request.getParameter("cod_equipo")));
%>
		<div id="page-wrapper">
					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<form action="operaciones_alu.jsp?tipo=modificarEquipo" method="post">
									<div class="row gtr-50">
										
										<div class="">
											<input type="text" value="<%=equipo.getNombre() %>" name="nombre_equipo" id="nombre_equipo" placeholder="Nombre del equipo" style="width:450px"; maxlength="20"/>
										</div>
										<div class="">
									...
									<input type="Hidden" name="cod_equipo" value="<%=equipo.getCod_equipo()%>"/>
