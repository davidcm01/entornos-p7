					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<h3>Alta Liga</h3>
								<form action="operaciones_alu.jsp?tipo=altaliga" method="post">
									<div class="row gtr-50">
										<div class="">
											<input type="text" name="nombre_liga" id="nombre_liga" placeholder="Nombre de la liga" style="width:450px"; maxlength="20"/>
										</div>
										
										<div class="">
											<input type="text" name="pais_liga" id="pais_liga" placeholder="País de la liga " maxlength="20"/>
										</div>
