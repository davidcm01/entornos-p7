...
Liga liga = bdcontroller.dameLiga(Integer.parseInt(request.getParameter("cod_liga")));
%>
		<div id="page-wrapper">
					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<form action="operaciones_alu.jsp?tipo=modificarliga" method="post">
									<div class="row gtr-50">
										<div class="">
											<input type="text" value="<%=liga.getNombre() %>" name="nombre_liga" id="nombre_liga" placeholder="Nombre de la liga" style="width:450px"; maxlength="20"/>
										</div>
										
										<div class="">
											<input type="text" value="<%=liga.getPais() %>"  name="pais_liga" id="pais_liga" placeholder="País de la liga " maxlength="20"/>
										</div>
										<input type="Hidden" name="cod_liga" value="<%=liga.getCod_liga()%>"/>
