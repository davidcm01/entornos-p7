					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<h3>Baja Equipo</h3>
								<form action="operaciones_alu.jsp?tipo=bajaequipo" method="post">
									<div class="row gtr-50">
										
										<div class="">
										<!-- 	<input type="number" name="cod_equipo" id="cod_equipo" placeholder="Código del equipo" maxlength="3"/> -->
											
											<select name="cod_equipo" id="cod_equipo" is ="ms-dropdown" required style="width:450px" data-child-height="415">
