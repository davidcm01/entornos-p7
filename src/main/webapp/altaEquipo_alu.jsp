					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<h3>Alta Equipo</h3>
								<form action="operaciones_alu.jsp?tipo=altaequipo" method="post">
									<div class="row gtr-50">
										
										<div class="">
											<input type="text" name="nombre_equipo" id="nombre_equipo" placeholder="Nombre del equipo" style="width:450px"; maxlength="20"/>
										</div>
										<div class="">
