					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<h3>Alta Jugador</h3>
								<form action="operaciones_alu.jsp?tipo=altajugador" method="post">
									<div class="row gtr-50">
										<div class="">
											<input type="text" name="nombre" id="nombre" placeholder="Nombre del jugador" style="width:450px"; maxlength="20"/>
										</div>
										<div class="">
											<input type="text" name="pierna" id="pierna" placeholder="Pierna buena del jugador" maxlength="9"/>
										</div>
										<div class="">
											
											<select  name="codEquipo" id="cod_equipo" is ="ms-dropdown" required style="width:450px" data-child-height="415">
											<option value="0">Seleccione una equipo</option>
										...
										<div class="">
											<input type="text" name="pais" id="pais" placeholder="País del jugador " maxlength="20"/>
										</div>
										<div class="">
											<input type="number" name="altura" id="altura" placeholder="Altura del jugador" maxlength="4"/>
										</div>
									...
									<div style="padding-top:22px;">
											<ul class="actions">
												<li><input type="submit" class="button alt" value="Dar de alta" /></li>
											</ul>
									</div>
